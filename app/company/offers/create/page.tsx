...
export default function CreateOfferPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    duration: "",
    requirements: "",
    // Add default status if needed, though API guide doesn't list it for creation
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = err.response?.data?.message || "Une erreur est survenue lors de la création de l'offre.";
  ...
  // Render form only if authenticated and is COMPANY
  if (!isAuthenticated || role !== "COMPANY") {
